...
export const options: NextAuthOptions = {
  ...
  providers: [
    ...
    CredentialsProvider({
      ...
      async authorize(credentials: any) {
        ...
        const token = cookieStore.get("bloomza_token");
        ...
        console.log("credentialsUpdate", data);
        if (credentials?.typeLogin === "pass") {
          result = await axios
  ...
  secret: "hWq1Ud6j39SNtfJsYzrZ0IZIjUVzDPdjhes8V/a5foI=",
  session: {
    strategy: "jwt",
